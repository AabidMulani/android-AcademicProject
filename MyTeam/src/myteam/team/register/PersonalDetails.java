	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Next_Btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				((MyTeam)getApplication()).PlayButtonSound();
				if (ValidateIt()) {
					EmployeeValues.setFirst_Name(FirstName_Txt.getText()
							.toString());
					EmployeeValues.setLast_Name(LastName_Txt.getText()
							.toString());
					EmployeeValues.setGender(gender.getSelectedItem()
							.toString());
					EmployeeValues.setDOB(DOB_Txt.getText().toString());
					EmployeeValues.setDesignation(Designation_Txt.getText()
							.toString());
